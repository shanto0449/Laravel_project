                    ...
                    <div class="main-post">
                        ...
                        <div class="post-icons-area">
                            <ul class="post-icons">
                                ...
                                <li>
                                    <a href="#"><i class="ion-chatbubble">{{ $post->comments->count() }}</i></a>
                                </li>
                                <li>
                        ...
                        <div class="tag-area">
                            ...
                            <ul>
                                @foreach ($post->categories as $category)
                                    <l><a href="{{ route('categoty.posts', $category->slug) }}">{{ $category->name }}</a>
                                        </li>
                                @endforeach
                            ...
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <ul class="post-footer">
                                        ...
                                        <li>
                                            <a href="#"><i
                                                    class="ion-chatbubble">{{ $randompost->comments->count() }}</i></a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="ion-eye">{{ $randompost->view_count }}</i></a>
                                        </li>
                                    </ul>
